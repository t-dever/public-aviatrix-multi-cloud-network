...
module "azure_aviatrix_controller" {
  source = "git::https://github.com/t-dever/public-reusable-aviatrix-terraform-modules//modules/azure/azure_aviatrix_controller?ref=features/addAzureController"
